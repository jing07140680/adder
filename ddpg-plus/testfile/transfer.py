...
def transfer(records,trail,dsmap,act_net,gold):
    ...
    while True:
        ...
        # limit on latency when belief is high
        #the closer to 20000 the better if belief is high, to save more energy
        reward = 5*belief*(20000-max(act_,act3))/9000  + standard/energy -latency/90000
...
if __name__ == "__main__":
    ...
    writer = SummaryWriter(comment="-ddpg_" + "transfer_new")
