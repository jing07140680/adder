...
if __name__ == "__main__":
    ...
    act_net = model.DDPGActor(5, env.action_space.shape[0]).to(device)
    crt_net = model.DDPGCritic(5,env.action_space.shape[0]).to(device)
    ...
    with ptan.common.utils.RewardTracker(writer) as tracker:
        with ptan.common.utils.TBMeanTracker(writer, batch_size=1) as tb_tracker:
            while True:
                ...
                print("buffersize: ", shared_buffer.size())
                ...
                #print(states_v, actions_v, rewards_v, dones_mask, last_states_v)
                #for o in range(10):
                ...
                q_last_v = crt_net(last_states_v, last_act_v)
